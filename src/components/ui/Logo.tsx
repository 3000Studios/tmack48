...
export default function Logo({ className = "" }: { className?: string }) {
  return (
    ...
    >
      <span
        className="relative grid h-11 w-11 sm:h-12 sm:w-12 place-items-center rounded-xl overflow-hidden animate-[pulseGlow_3s_ease-in-out_infinite]"
        style={{
      ...
      >
        <span className="font-display font-black text-ink-950 text-xl leading-none">T48</span>
