    ...
    <>
      ...
      >
        <div className="container-lux flex h-16 md:h-20 items-center justify-between gap-3 md:gap-4">
          ...
          <nav
            aria-label="Primary"
            className="hidden lg:flex flex-1 min-w-0 items-center justify-center gap-2 xl:gap-5 overflow-x-auto px-2"
          >
            {items.map((it) => (
              <NavLink
                key={it.href}
                ...
                className={({ isActive }) =>
                  cn(
                    "link-rise link-u glint whitespace-nowrap rounded-lg px-2 py-1 text-[11px] xl:text-sm uppercase tracking-[0.16em] xl:tracking-[0.22em] font-medium transition-colors",
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                cn(
                  "btn-gold !px-3 xl:!px-4 !py-2 text-[10px] xl:text-xs uppercase tracking-[0.18em] shrink-0 shadow-[0_8px_30px_-12px_rgba(212,175,55,0.55)]",
